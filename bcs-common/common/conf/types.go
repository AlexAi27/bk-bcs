...
type CustomCertConfig struct {
	...
	ServerKeyFile  string `json:"custom_server_key_file" value:"" usage:"Custom Server private key file(*.key). If both server_cert_file and server_key_file are set, it will set up an HTTPS server" mapstructure:"custom_server_key_file"`
	ServerKeyPwd   string `json:"custom_server_key_password" value:"" usage:"specific the custom server tls key file pwd" mapstructure:"custom_server_key_password"`
	ClientCertFile string `json:"custom_client_cert_file" value:"" usage:"Custom Client public key file(*.crt)" mapstructure:"client_cert_file" mapstructure:"custom_client_cert_file"`
	ClientKeyFile  string `json:"custom_client_key_file" value:"" usage:"Custom Client private key file(*.key)" mapstructure:"client_key_file" mapstructure:"custom_client_key_file"`
	ClientKeyPwd   string `json:"custom_client_key_password" value:"" usage:"specific the custom client tls key file pwd" mapstructure:"custom_client_key_password"`
}
